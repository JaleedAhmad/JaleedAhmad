...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0a0a0a,50:00d2ff,100:00ff9f&height=120&section=header&text=&animation=fadeIn" width="100%"/>

</div>

---

<img align="right" src="https://github.com/JaleedAhmad/JaleedAhmad/raw/main/Cat.gif" width="180px" style="margin-left: 20px; border-radius: 12px;"/>
...
name        : Jaleed Ahmad
age         : 22
role        : AI/ML Engineer & MLOps Architect
...
I sit at the intersection of **model building** and **systems engineering** — architecting RAG pipelines, agentic workflows, and cloud infrastructure that takes AI from prototype to production.
...
![LangGraph](https://img.shields.io/badge/LangGraph-00D2FF?style=flat-square&logoColor=white)
...
| 🏍️ **[Blizzup Agentic Dealership](https://github.com/JaleedAhmad/blizzup-fullstack-assessment)** | `React` `Gemini` `Node.js` | AI-driven vehicle comparison & inventory management platform · [Live](https://blizzup-fullstack-assessment.vercel.app/) |
| 👁️ **[Fundus Vessel Segmentation](https://github.com/JaleedAhmad/fundus-vessel-segmentation)** | `TensorFlow` `U-Net` `Flask` | Deep learning retinal blood vessel segmentation on the DRIVE dataset |
| 🌦️ **[Weather & Chat Dashboard](https://github.com/JaleedAhmad/weather-chat-dashboard)** | `Python` `Mistral AI` `RPi` | IoT weather monitor fusing DHT11 sensor telemetry with an AI chat interface |
| ⚙️ **[DevOps for ML](https://github.com/JaleedAhmad/DevOps-Training)** | `Terraform` `Jenkins` `Prometheus` | Automated HA infrastructure lifecycle with monitoring for production ML workloads |
...
```
[Feb 2026 → Present]  Trainee AI/ML & DevOps Engineer  ·  T8 Launchpad (NASTP Delta), Lahore
                      ↳ Cloud-native AI solutions · ML model deployment automation
                      ↳ RAG pipelines for enterprise contextual intelligence
                      ↳ Serverless workflows for large-scale AI dataset processing on AWS & GCP

[Sep 2025 → Oct 2025] NLP Intern  ·  Elevvo  (Remote)
                      ↳ Text-processing workflows · transformer-based NLP architectures

[Jul 2024 → Oct 2025] IoT Intern  ·  Kun Techs, Faisalabad
                      ↳ Cloud-integrated IoT systems · real-time sensor processing
```
...
→  Stateful AI agent pipelines & supervisor patterns
...
🛠️  Engineer AI Agents with ADK
🎯  Prompt Design in Vertex AI
✨  Explore Generative AI with Vertex AI Gemini API
```

🏅 [View all credentials on Credly →](https://www.credly.com/users/jaleed-ahmad/skills)
...
<img src="https://github-readme-stats-alpha.vercel.app/api?username=JaleedAhmad&show_icons=true&theme=transparent&title_color=00d2ff&icon_color=00ff9f&text_color=c0c0c0&bg_color=00000000&hide_border=true&rank_icon=github" height="155"/>
<img src="https://github-readme-stats-alpha.vercel.app/api/top-langs/?username=JaleedAhmad&layout=compact&theme=transparent&title_color=00d2ff&text_color=c0c0c0&bg_color=00000000&hide_border=true" height="155"/>
...
[![Credly](https://img.shields.io/badge/Credly-FF6B00?style=for-the-badge&logo=credly&logoColor=white)](https://www.credly.com/users/jaleed-ahmad/skills)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:00ff9f,50:00d2ff,100:0a0a0a&height=100&section=footer" width="100%"/>
